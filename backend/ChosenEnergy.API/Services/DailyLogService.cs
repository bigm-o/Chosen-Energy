...
public class DailyLogService : IDailyLogService
{
    ...
    public async Task<dynamic> GetDriverDailyLogAsync(Guid userId, DateTime date)
    {
        try 
        {
            ...
            // Calculate today's metrics safely (Dynamic: count Pending as already affecting truck inventory)
            // These sums purely represent NEW movements recorded on this specific day.
