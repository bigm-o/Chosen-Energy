        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 min-h-[400px]">
                                ...
                                <div className="hidden md:block overflow-x-auto">
                                    <table className="w-full">
                                        <thead className="bg-gray-50 border-b border-gray-100">
                                            <tr>
                                                <th className="text-left py-3 px-4 text-xs font-black text-gray-500 uppercase tracking-widest">Name</th>
                                                <th className="text-left py-3 px-4 text-xs font-black text-gray-500 uppercase tracking-widest">Role</th>
                                                <th className="text-left py-3 px-4 text-xs font-black text-gray-500 uppercase tracking-widest">Email</th>
                                                <th className="text-left py-3 px-4 text-xs font-black text-gray-500 uppercase tracking-widest">Status</th>
                                                <th className="text-right py-3 px-4 text-xs font-black text-gray-500 uppercase tracking-widest">Action</th>
                                            </tr>
                                        </thead>
                                            ...
                                            {users.map((u) => (
                                                <tr key={u.id} className="hover:bg-gray-50 transition-colors">
                                                    <td className="py-3 px-4 text-sm font-bold text-gray-900">
                                                        {u.fullName}
                                                        <div className="text-xs font-normal text-gray-500">@{u.username}</div>
                                                    </td>
                    ...
                    <div className="p-8 space-y-8">
                        <div className="max-w-xl space-y-6">
                            <div>
                                ...
                                <div className="space-y-3">
                                    <label className="flex items-center justify-between p-4 border border-gray-200 rounded-xl hover:bg-gray-50 cursor-pointer">
                                        <span className="text-sm font-medium text-gray-700">Email Alerts for Approvals</span>
                            ...
                            <div>
                                ...
                                <div className="space-y-3">
                                    <button className="w-full text-left p-4 border border-gray-200 rounded-xl hover:bg-gray-50 font-medium text-gray-700">
                ...
                {activeTab === 'database' && (
                    <div className="p-8 text-center py-20">
                        ...
                        <p className="text-gray-500 mb-8">Current Database Size: 45MB • Last Backup: 2 hours ago</p>
            ...
            <Modal isOpen={showAddModal} onClose={() => setShowAddModal(false)} title="Create New User" size="md">
                <form onSubmit={handleAddUser} className="space-y-4">
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        <button type="button" onClick={() => setShowAddModal(false)} className="px-4 py-2 text-gray-500 font-bold hover:bg-gray-100 rounded-lg">Cancel</button>
            ...
            <Modal isOpen={showEditModal} onClose={() => setShowEditModal(false)} title="Edit User" size="md">
                <form onSubmit={handleEditUser} className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-xs font-bold text-gray-500 uppercase mb-1">Username (Read-only)</label>
                            <input
                                type="text"
                                value={formData.username}
                                readOnly
                                className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-gray-500 bg-gray-100"
                            />
                        </div>
                        <div>
                            <label className="block text-xs font-bold text-gray-500 uppercase mb-1">Role</label>
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        <button type="button" onClick={() => setShowEditModal(false)} className="px-4 py-2 text-gray-500 font-bold hover:bg-gray-100 rounded-lg">Cancel</button>
